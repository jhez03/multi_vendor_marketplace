...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function setCustomerProfile(?CustomerProfile $customerProfile): static
    {
        $this->customerProfile = $customerProfile;

        if ($customerProfile && $customerProfile->getUser() !== $this) {
    ...
    public function setSellerProfile(?SellerProfile $sellerProfile): static
    {
        ...
        if ($sellerProfile && $sellerProfile->getUser() !== $this) {
